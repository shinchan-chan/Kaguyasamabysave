...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://adamopytbusiness1:uSswEjo4ZHMGDU8Z@cluster0.gqgmk.mongodb.net/?retryWrites=true&w=majority&appName=KaguyaShinomiyaFileBot")
DB_NAME = os.environ.get("DATABASE_NAME", "Kaguya_Shinomiya_File_Bot")
